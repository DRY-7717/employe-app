...
@section('section')
    <div class="page-heading">
        ...
        <section class="section">
            <div class="card">
                <form action="/dashboard/payroll/salary" method="POST" class="form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="salary"
                                        ...
                                        placeholder="Input gaji pokok" name="salary" value="{{ old('salary') }}">
                                    @error('salary')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
