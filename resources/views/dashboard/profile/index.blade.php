                        ...
                        <div class="card-header text-center">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mx-auto">
                                    <input type="file"
                                        class="form-control mt-2 @error('img_profile') is-invalid @enderror"
                                        id="customFile" name="img_profile" onchange="previewImage()" placeholder="">
                                    @error('img_profile')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="tgl_lahir"
                                            ...
                                            name="tgl_lahir" placeholder="Input your postal code"
